...
<div id="mainWrapper">
  <header> 
    ...
    <div id="logo"><img src="./img/logo.png" alt="sample logo"></div>
    <%
	...
	%>
		<article>
        	<div>
        		...
        		<b>
        		<a href="./jsp/getsingleNews.jsp?id=<%=m.get("id")%>" style="font-size: 25px;"><%=m.get("title") %></a>
        		&nbsp;&nbsp;&nbsp;&nbsp;发布日期:<%=m.get("date")%>&nbsp;&nbsp;&nbsp;&nbsp;浏览量:<%=m.get("view") %>
        		</b>
        		</p>
