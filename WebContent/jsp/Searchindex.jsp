    ...
    try{  
        ...
        <article>
        	<div>
        		...
        		<b>
        		<a href="getsingleNews.jsp?id=<%=id %>" style="font-size: 25px;"><%=title %></a>
        		&nbsp;&nbsp;&nbsp;&nbsp;发布日期:<%=date%>&nbsp;&nbsp;&nbsp;&nbsp;浏览量:<%=view %>
        		</b>
        		</p>
...
%>
<a href = "Searchindex.jsp?curPage=1" >首页</a>  
<a href = "Searchindex.jsp?curPage=<%=curPage-1%>" >上一页</a>  
<a href = "Searchindex.jsp?curPage=<%=curPage+1%>" >下一页</a>  
<a href = "Searchindex.jsp?curPage=<%=pageCount%>" >尾页</a>  
