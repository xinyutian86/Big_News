...
<body>
	...
	<p align="center"><a href="add.html">添加新闻</a></p>
	...
	%>
		...
		<td><%= m.get("discuss") %></td><td><a href="../jsp/edit.jsp?id=<%=m.get("id")%>">修改</a>&nbsp;<a href="../jsp/del.jsp?id=<%=m.get("id")%>" onclick="return confirm('确定要删除吗?')">删除</a></td></tr>
	<%
		}
	%>
	</table>
