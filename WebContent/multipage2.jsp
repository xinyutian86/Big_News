...
<%!  
    public static final String DRIVER = "com.mysql.jdbc.Driver";  //改成sql server的
    public static final String USER = "xxx";  //你的用户名
    public static final String PASS = "xxx";  //你的密码
    public static final String URL = "jdbc:mysql://127.0.0.1:1433/xxx";  //你的数据库名字
